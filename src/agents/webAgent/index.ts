// import { getLLM } from "@/server/ai/llm";
// import { DEFAULT_SMALL_MODEL } from "@/server/ai/llm";
...
//   const llm = getLLM(MODELS.GROK_CODE_FAST_1);
...
//     },
//     onStepFinish: (step) => {
//       console.log("Reasoning", step.reasoning, step.reasoningDetails);
//       if (step.toolCalls) {
...
//   const allResources = (
//     await Promise.all(subtasks.subtasks.map((subtask) => webAgent(subtask)))
//   )
